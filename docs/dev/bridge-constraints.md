...
- preserve ephemeral-media intent where platforms allow it: Discord spoiler media attachments should become WhatsApp `viewOnce` media, and WhatsApp view-once media should be uploaded to Discord as spoiler attachments
